...
const MyReferrals = () => {
    ...
    useEffect(() => {
        const getR = async () => {
            ...
            const { data } = await axios.get("https://ecommerce-97tk.onrender.com/referral/myreferrals", {
                params: {
    ...
    useEffect(() => {
        const getR = async () => {
            ...
            const { data } = await axios.get("https://ecommerce-97tk.onrender.com/api/user/sales", {
                params: {
                    id: JSON.parse(localStorage.getItem("user"))._id
                }
            })
        ...
        <div id='myreferralDiv'>
            ...
            {referralsArr.map((product) => (
                <div className='eachReferralDiv'>
                    ...
                    <div>
                        <a href={"https://ecommerce-97tk.onrender.com/referral?id=" + product.refId} style={{ textDecoration: "none" }}>{"https://ecommerce-97tk.onrender.com/referral?id=" + product.refId}</a>
